...
public class KakaoAuthToken {
    ...
    private final static String K_CLIENT_ID = "나의 앱 키 입력"; // "나의 앱 키 입력"
    private final static String K_REDIRECT_URI = "리다이렉트 주소입력"; //"리다이렉트 주소입력 - http://localhost:8080/daily-photolog/app/oauth"
